...
export default function SearchPage() {
    ...
    const parseSearchQuery = () => {
        ...
        return {
            ...
            initOpenAdvanced: query.showAdvanced ? Boolean(query.showAdvanced): false,
        }
    };
    ...
    return (
        <div className={styles.container}>
            <div style={{width: '80%'}}>
            <SearchContainer oldQuery={curQuery.query} hiddenResult={false} onContentRefresh={() => {}} searchJump={true} initOpenAdvanced={curQuery.initOpenAdvanced}/>
            </div>
        </div>
    )
}